...
const INITIAL_NEWS = [
  {
    id: 6,
    title: "⚠️ बेसी स्थगित — नई तिथि की सूचना दी जाएगी",
    body: "गाँव में किसी की अकस्मात मृत्यु हो जाने के कारण बेसी स्थगित कर दी गई है। नई तारीख की सूचना शीघ्र दी जाएगी। ग्रामवासियों से अनुरोध है कि इस दुख की घड़ी में परिवार का साथ दें।",
    date: "16 मार्च 2026",
    tag: "उत्सव",
  },
];
        ...
        >
          ...
          >
            {newsList.length > 0
              ...
              : "📰 ⚠️ बेसी स्थगित — नई तिथि की सूचना दी जाएगी"}
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </div>
        </div>
...
function PhotosPage({ isAdmin }: { isAdmin?: boolean }) {
  ...
  const handleUpload = async () => {
    ...
    if (uploadFile.size > maxPhotoSize) {
      toast.error("फोटो 5MB से बड़ी नहीं होनी चाहिए। कृपया छोटी फोटो चुनें।");
      return;
    }
    setIsUploading(true);
    setUploadProgress(0);
    let lastError: unknown = null;
    const qualities = [0.5, 0.35, 0.25, 0.15, 0.1];
